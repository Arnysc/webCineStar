<%@ Page Title="" Language="C#" MasterPageFile="~/master/CineStar.master" AutoEventWireup="true" CodeFile="verPelicula.aspx.cs" Inherits="pages_verPelicula" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="contenido-pelicula">
        ...
        <img src="../img/pelicula/1.jpg" width="160" height="226">
        <br/>
        <br/>
    </div>
