<%@ Page Title="" Language="C#" MasterPageFile="~/master/CineStar.master" AutoEventWireup="true" CodeFile="verPeliculas.aspx.cs" Inherits="pages_verPeliculas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="contenido-pelicula">
        ...
        <img src="../img/pelicula/10.jpg" width="160" height="226" />
        <br/>
        <br/>
    </div>
</asp:Content>
